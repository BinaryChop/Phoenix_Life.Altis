class TrunkMenu
{
	...
	class controlsBackground
	{
		...
		class RscBackground : Life_RscText //Background
		{
		...
		class RscTitleText : Life_RscTitle //Name
		{
		...
		class VehicleWeight : RscTitleText //Trunk
		{
			idc = 3504;
			style = 0; //1
			text = "";
	...
	class Controls
	{
		...
		class TakeItem10 : Life_RscButtonMenu
		{
			...
			text = "---++";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[2] call life_fnc_vehTakeItem;";
			x = 0.415; y = 0.40;
			w = (6.25 / 90);
			h = (1 / 25);
		};
		...
		class StoreItem10 : Life_RscButtonMenu
		{
			...
			text = "++---";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[2] call life_fnc_vehStoreItem;";
			x = 0.415; y = 0.55;
			w = (6.25 / 90);
			h = (1 / 25);
		};
