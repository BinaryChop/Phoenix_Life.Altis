...
player createDiaryRecord ["controls",
	["",
		...
		+ "Links STRG + E: in Fahrzeug einsteigen<br /><br />"
		+ "Links SHIFT + E (Im Auto): Aus Fahrzeug aussteigen und Waffe Holstern<br /><br />"
		+ "F: Polizeisirene (nur Polizei)<br /><br />"
		+ "Links SHIFT + L: Blaulicht (nur Polizei)<br /><br />"
		+ "Links SHIFT + R: Fesseln (nur Polizei)<br /><br />"
		+ "Links SHIFT + G: KO Schlagen (nur Zivilist, wird zum Ausrauben benutzt)<br /><br />"
		+ "Windows Taste: Haupttaste, die benutzt wird, um Gegenstände aufzunehmen, mit Fahrzeugen zu interagieren oder als Polizist mit Zivilisten zu interagieren.<br /><br />"
		+ "Links SHIFT + Numpad 1: Kniebeugen<br /><br />"
		+ "Links SHIFT + Numpad 2: Sportübung<br /><br />"
		+ "Links SHIFT + Numpad 3: Liegestützen<br /><br />"
		+ "Links SHIFT + Numpad 5: Hörgerät An / Aus<br /><br />"
		+ "Links SHIFT + Numpad 8: Ergeben<br /><br />"
	]
];