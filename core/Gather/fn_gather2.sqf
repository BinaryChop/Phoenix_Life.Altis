...
switch(true) do {
	case (_zone in ["apple_1","apple_2","apple_3","apple_4"]): {_gather = "apple"; _val = round(random 3)+3;};
	case (_zone in ["peaches_1","peaches_2","peaches_3"]): {_gather = "peach"; _val = round(random 4)+3;};
	...
	case (_zone in ["Birnen_1","Birnen_2","Birnen_3","Birnen_4"]): {_gather = "Birnen"; _val = round(random 3)+3;};
	case (_zone in ["food_1_4","food_1_7","food_1_2"]): {_gather = "trauu"; _val = round(random 3)+2;};
