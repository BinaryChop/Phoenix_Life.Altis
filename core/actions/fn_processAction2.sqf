/* author: preller @ freudenhaus <codepreller@hirnstrom.net> Reworked for Phoenix Life by Ministry of Mad Men 
*
...
_productionInfo = switch (_type) do
{
	...
	case "blasting": {[["cables","lwatch","tnt","calc"],[2,1,1,1],"blastingcharge",1];};
	case "robo": {[["robo1","robo2","robo3","robo4","robo5","robo6"],[1,1,1,1,1,1],"robo",1];};
	case "axe": {[["bpaxe","steel","plastic","cables"],[1,3,3,5],"axe",1];};
	case "pickaxe": {[["bppickaxe","steel","plastic","cables"],[1,3,3,5],"pickaxe",1];};
