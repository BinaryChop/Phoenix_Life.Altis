...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","pears_1","pears_2","pears_3","pears_4","grapes_1","grapes_2","grapes_3","grapes_4","lsd_1","lsd_2","heroin_1","heroin_2","heroin_3","cocaine_1","cocaine_2","cocaine_3","weed_1","weed_2","weed_3","copper_1","iron_1","gold_1","titan_1","coal_1","diamond_1","saphir_1","salt_1","sand_1","diamond_1","saphir_1","oil_1","oil_2","rock_1","krok_1","krok_2","meth_1","meth_2","meth_3","lsd_1","lsd_2","rye_1","hops_1","cornmeal_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["pears_1","pears_2","pears_3","pears_4"]): {"pear"};
	case (_zone in ["grapes_1","grapes_2","grapes_3","grapes_4"]): {"grape"};
	
	//drugs
	case (_zone in ["heroin_1","heroin_2","heroin_3"]): {"heroinu"};
	case (_zone in ["cocaine_1","cocaine_2","cocaine_3"]): {"cocaine"};
	case (_zone in ["weed_1","weed_2","weed_3"]): {"cannabis"};
	case (_zone in ["krok_1","krok_2"]): {"kroku"};
	case (_zone in ["lsd_1","lsd_2"]): {"methu"};
	case (_zone in ["meth_1","meth_2","meth_3"]): {"lsdu"};
	
	//Ore & stones
	case (_zone in ["copper_1"]): {"copperore"};
	case (_zone in ["iron_1"]): {"ironore"};
	case (_zone in ["gold_1"]): {"goldore"};
	case (_zone in ["titan_1"]): {"titanore"};
	case (_zone in ["coal_1"]): {"coal"};
	case (_zone in ["rock_1"]): {"rock"};
	case (_zone in ["diamond_1"]): {"diamond"};
	case (_zone in ["saphir_1"]): {"saphir"};
