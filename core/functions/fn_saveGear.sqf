...

{
    ...
    ["life_inv_woodleg", life_inv_woodleg],
    ["life_inv_shoki", life_inv_shoki],
    ["life_inv_robo1", life_inv_robo1],
    ["life_inv_robo2", life_inv_robo2],
    ["life_inv_robo4", life_inv_robo4],
    ["life_inv_robo5", life_inv_robo5],
    ["life_inv_robo6", life_inv_robo6],
    ["life_inv_robo", life_inv_robo],
    ["life_inv_calc", life_inv_calc],
    ["life_inv_lwatch", life_inv_lwatch],
    ["life_inv_dinobone", life_inv_dinobone],
    ["life_inv_cables", life_inv_cables],
    ["life_inv_tnt", life_inv_tnt],
    ...
    ["life_inv_ladegeraet", life_inv_ladegeraet]
];
